...
ACCOUNT_SID = os.getenv("TWILIO_ACCOUNT_SID", "AC151c6b601ff1edf3a341ca479dcc8004").strip()
AUTH_TOKEN = os.getenv("TWILIO_AUTH_TOKEN", "5003ac83ee15dd69f0692ea8fb3ad3f6").strip()
TWILIO_NUMBER = os.getenv("TWILIO_NUMBER", "+18568050268").strip()
...
def check_absentees(client: Client | None) -> None:
    ...
    if students_df.empty:
        print("⚠️ No students registered yet; skipping check.")
        return
